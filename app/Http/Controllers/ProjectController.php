...
class ProjectController extends Controller
{
    ...
    {
        $project_categories_data = ProjectCategory::findOrFail($id);
        $projects = Project::where('project_categorie_id', $id)->get();
        return view('project.show', compact('project_categories_data', 'projects'));
    }
